...
-- Started on 2018-03-01 15:25:08
...
--
-- TOC entry 245 (class 1255 OID 714493)
...
--
-- TOC entry 246 (class 1255 OID 714495)
...
--
-- TOC entry 247 (class 1255 OID 714496)
...
--
-- TOC entry 248 (class 1255 OID 714497)
...
--
-- TOC entry 276 (class 1255 OID 716831)
...
CREATE FUNCTION "deleteoggettiinfo"("codicescheda" bigint, "codicecampo" integer) RETURNS "text"
  ...
  DECLARE
  BEGIN
	DELETE FROM "Oggetti_Schede" WHERE "Codice" = codiceScheda AND "CodiceCampo" = codiceCampo;
...
-- Name: deleteoggettiversioniinfo(bigint, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "deleteoggettiversioniinfo"("codicescheda" bigint, "codicecampo" integer) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
  BEGIN
	DELETE FROM "OggettiVersion_Schede" WHERE "Codice" = codiceScheda AND "CodiceCampo" = codiceCampo;
...
ALTER FUNCTION "public"."deleteoggettiversioniinfo"("codicescheda" bigint, "codicecampo" integer) OWNER TO "postgres";

--
-- TOC entry 249 (class 1255 OID 714500)
...
--
-- TOC entry 250 (class 1255 OID 714501)
...
--
-- TOC entry 251 (class 1255 OID 714502)
...
--
-- TOC entry 252 (class 1255 OID 714503)
...
--
-- TOC entry 253 (class 1255 OID 714504)
...
--
-- TOC entry 254 (class 1255 OID 714505)
...
--
-- TOC entry 255 (class 1255 OID 714506)
...
--
-- TOC entry 278 (class 1255 OID 716828)
-- Name: setoggettiinfocombovalue(bigint, integer, "text", "text", bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiinfocombovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" bigint) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
	...
	auxint int;
  BEGIN
	codiceCampo := (SELECT "Codice" FROM "Oggetti_ListaInformazioni" WHERE "CodiceTitolo" = codicetitolo AND "Campo" = nomecampo);
	IF (codiceTitolo is NULL) THEN
		RAISE EXCEPTION 'Can''t find (%) field inside (%) information group',nomecampo,titoloscheda;
	END IF;

	IF (valore IS NOT NULL) THEN
		sql_insert := 'INSERT INTO "Oggetti_Schede" ("Codice", "CodiceCampo", "ComboValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
...
ALTER FUNCTION "public"."setoggettiinfocombovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" bigint) OWNER TO "postgres";

--
-- TOC entry 258 (class 1255 OID 714508)
...
CREATE FUNCTION "setoggettiinfoschedacombovalue"("codiceoggetto" bigint, "titoloscheda" "text", "nomecampo" "text", "valore" bigint) RETURNS "text"
  ...
  DECLARE
	...
	auxint int;
  BEGIN
	codiceTitolo := (SELECT "Codice" FROM "Oggetti_ListaSchede" WHERE "Titolo" = titoloscheda);
	IF (codiceTitolo is NULL) THEN
		RAISE EXCEPTION 'Can''t find (%) information group', titoloscheda;
	END IF;
	...
	select setoggettiinfocombovalue(codiceScheda, codiceTitolo, titoloscheda, nomecampo, valore) INTO tmpRecord;
...
--
-- TOC entry 271 (class 1255 OID 714509)
...
CREATE FUNCTION "setoggettiinfoschedavalue"("codiceoggetto" bigint, "titoloscheda" "text", "nomecampo" "text", "valore" boolean) RETURNS "text"
  ...
  BEGIN
	...
	select setoggettiinfovalue(codiceScheda, codiceTitolo, titoloscheda, nomecampo, valore) INTO tmpRecord;
...
--
-- TOC entry 272 (class 1255 OID 714510)
...
--
-- TOC entry 256 (class 1255 OID 714511)
...
--
-- TOC entry 270 (class 1255 OID 714512)
...
--
-- TOC entry 257 (class 1255 OID 714513)
...
--
-- TOC entry 275 (class 1255 OID 716826)
-- Name: setoggettiinfovalue(bigint, integer, "text", "text", boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" boolean) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		...
		sql_update := 'UPDATE "Oggetti_Schede" SET "BoolValue" = ' || valore || ', "IntValue" = null, "RealValue" = null, "TextValue" = null, "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" boolean) OWNER TO "postgres";

--
-- TOC entry 277 (class 1255 OID 716827)
-- Name: setoggettiinfovalue(bigint, integer, "text", "text", real); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" real) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		...
		sql_update := 'UPDATE "Oggetti_Schede" SET "BoolValue" = null, "IntValue" = null, "RealValue" = ' || valore || ', "TextValue" = null, "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" real) OWNER TO "postgres";

--
-- TOC entry 269 (class 1255 OID 716822)
-- Name: setoggettiinfovalue(bigint, integer, "text", "text", integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" integer) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		...
		sql_update := 'UPDATE "Oggetti_Schede" SET "BoolValue" = null, "IntValue" = ' || valore || ', "RealValue" = null, "TextValue" = null, "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" integer) OWNER TO "postgres";

--
-- TOC entry 273 (class 1255 OID 716824)
-- Name: setoggettiinfovalue(bigint, integer, "text", "text", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" "text") RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		...
		sql_update := 'UPDATE "Oggetti_Schede" SET "BoolValue" = null, "IntValue" = null, "RealValue" = null, "TextValue" = ' || valore || ', "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" "text") OWNER TO "postgres";

--
-- TOC entry 274 (class 1255 OID 716825)
-- Name: setoggettiinfovalue(bigint, integer, "text", "text", timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" timestamp with time zone) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		...
		sql_update := 'UPDATE "Oggetti_Schede" SET "BoolValue" = null, "IntValue" = null, "RealValue" = null, "TextValue" = null, "TimestampValue" = ' || valore || ', "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" timestamp with time zone) OWNER TO "postgres";

--
-- TOC entry 288 (class 1255 OID 716837)
-- Name: setoggettiversioniinfocombovalue(bigint, integer, "text", "text", bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiversioniinfocombovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" bigint) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
	...
	auxint int;
  BEGIN
	codiceCampo := (SELECT "Codice" FROM "OggettiVersion_ListaInformazioni" WHERE "CodiceTitolo" = codicetitolo AND "Campo" = nomecampo);
	IF (codiceTitolo is NULL) THEN
		RAISE EXCEPTION 'Can''t find (%) field inside (%) information group',nomecampo,titoloscheda;
	END IF;

	IF (valore IS NOT NULL) THEN
		sql_insert := 'INSERT INTO "OggettiVersion_Schede" ("Codice", "CodiceCampo", "ComboValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
...
ALTER FUNCTION "public"."setoggettiversioniinfocombovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" bigint) OWNER TO "postgres";

--
-- TOC entry 261 (class 1255 OID 714520)
...
CREATE FUNCTION "setoggettiversioniinfoschedacombovalue"("codiceversione" bigint, "titoloscheda" "text", "nomecampo" "text", "valore" bigint) RETURNS "text"
  ...
  DECLARE
	...
	auxint int;
  BEGIN
	codiceTitolo := (SELECT "Codice" FROM "OggettiVersion_ListaSchede" WHERE "Titolo" = titoloscheda);
	IF (codiceTitolo is NULL) THEN
		RAISE EXCEPTION 'Can''t find (%) information group', titoloscheda;
	END IF;

	codiceScheda := (SELECT "CodiceScheda" FROM "OggettiVersion_RelazioniSchede" WHERE "CodiceOggetto" = codiceoggetto AND "CodiceTitolo" = codiceTitolo);
	...
	select setoggettiversioniinfocombovalue(codiceScheda, codiceTitolo, titoloscheda, nomecampo, valore) INTO tmpRecord;
...
--
-- TOC entry 260 (class 1255 OID 714521)
...
CREATE FUNCTION "setoggettiversioniinfoschedavalue"("codiceversione" bigint, "titoloscheda" "text", "nomecampo" "text", "valore" boolean) RETURNS "text"
  ...
  BEGIN
	...
	select setoggettiversioniinfovalue(codiceScheda, codiceTitolo, titoloscheda, nomecampo, valore) INTO tmpRecord;
...
--
-- TOC entry 280 (class 1255 OID 714522)
...
--
-- TOC entry 259 (class 1255 OID 714523)
...
--
-- TOC entry 281 (class 1255 OID 714524)
...
--
-- TOC entry 279 (class 1255 OID 714525)
...
--
-- TOC entry 285 (class 1255 OID 716834)
-- Name: setoggettiversioniinfovalue(bigint, integer, "text", "text", boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" boolean) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		sql_insert := 'INSERT INTO "OggettiVersion_Schede" ("Codice", "CodiceCampo", "BoolValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
		sql_update := 'UPDATE "OggettiVersion_Schede" SET "BoolValue" = ' || valore || ', "IntValue" = null, "RealValue" = null, "TextValue" = null, "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" boolean) OWNER TO "postgres";

--
-- TOC entry 286 (class 1255 OID 716835)
-- Name: setoggettiversioniinfovalue(bigint, integer, "text", "text", real); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" real) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		sql_insert := 'INSERT INTO "OggettiVersion_Schede" ("Codice", "CodiceCampo", "RealValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
		sql_update := 'UPDATE "OggettiVersion_Schede" SET "BoolValue" = null, "IntValue" = null, "RealValue" = ' || valore || ', "TextValue" = null, "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" real) OWNER TO "postgres";

--
-- TOC entry 284 (class 1255 OID 716833)
-- Name: setoggettiversioniinfovalue(bigint, integer, "text", "text", integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" integer) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		sql_insert := 'INSERT INTO "OggettiVersion_Schede" ("Codice", "CodiceCampo", "IntValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
		sql_update := 'UPDATE "OggettiVersion_Schede" SET "BoolValue" = null, "IntValue" = ' || valore || ', "RealValue" = null, "TextValue" = null, "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" integer) OWNER TO "postgres";

--
-- TOC entry 283 (class 1255 OID 716830)
-- Name: setoggettiversioniinfovalue(bigint, integer, "text", "text", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" "text") RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL AND valore != '' AND trim(from valore) != '') THEN
		sql_insert := 'INSERT INTO "OggettiVersion_Schede" ("Codice", "CodiceCampo", "TextValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
		sql_update := 'UPDATE "OggettiVersion_Schede" SET "BoolValue" = null, "IntValue" = null, "RealValue" = null, "TextValue" = ''' || valore || ''', "TimestampValue" = null, "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" "text") OWNER TO "postgres";

--
-- TOC entry 287 (class 1255 OID 716836)
-- Name: setoggettiversioniinfovalue(bigint, integer, "text", "text", timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION "setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" timestamp with time zone) RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
	sql_insert text;
  ...
  BEGIN
	...
	IF (valore IS NOT NULL) THEN
		sql_insert := 'INSERT INTO "OggettiVersion_Schede" ("Codice", "CodiceCampo", "TimestampValue") VALUES (' || codiceScheda || ', ''' || codiceCampo || ''', ' || valore  || ')';
		sql_update := 'UPDATE "OggettiVersion_Schede" SET "BoolValue" = null, "IntValue" = null, "RealValue" = null, "TextValue" = null, "TimestampValue" = ' || valore || ', "ComboValue" = null WHERE "CodiceScheda" = ' || codiceScheda || ' AND "CodiceCampo" = ''' || codiceCampo || '''';
...
ALTER FUNCTION "public"."setoggettiversioniinfovalue"("codicescheda" bigint, "codicetitolo" integer, "titoloscheda" "text", "nomecampo" "text", "valore" timestamp with time zone) OWNER TO "postgres";

--
-- TOC entry 262 (class 1255 OID 714531)
...
--
-- TOC entry 263 (class 1255 OID 714532)
...
--
-- TOC entry 264 (class 1255 OID 714533)
...
--
-- TOC entry 265 (class 1255 OID 714534)
...
--
-- TOC entry 266 (class 1255 OID 714535)
...
--
-- TOC entry 267 (class 1255 OID 714536)
...
--
-- TOC entry 268 (class 1255 OID 714537)
...
--
-- TOC entry 173 (class 1259 OID 714538)
...
--
-- TOC entry 174 (class 1259 OID 714544)
...
--
-- TOC entry 175 (class 1259 OID 714547)
...
--
-- TOC entry 176 (class 1259 OID 714549)
...
--
-- TOC entry 232 (class 1259 OID 721350)
...
--
-- TOC entry 231 (class 1259 OID 721348)
...
--
-- TOC entry 177 (class 1259 OID 714560)
...
--
-- TOC entry 178 (class 1259 OID 714564)
...
--
-- TOC entry 179 (class 1259 OID 714569)
...
--
-- TOC entry 180 (class 1259 OID 714580)
...
--
-- TOC entry 181 (class 1259 OID 714590)
...
--
-- TOC entry 182 (class 1259 OID 714603)
...
--
-- TOC entry 183 (class 1259 OID 714608)
...
--
-- TOC entry 184 (class 1259 OID 714614)
...
--
-- TOC entry 185 (class 1259 OID 714616)
...
--
-- TOC entry 186 (class 1259 OID 714627)
...
--
-- TOC entry 187 (class 1259 OID 714638)
...
--
-- TOC entry 188 (class 1259 OID 714649)
...
--
-- TOC entry 189 (class 1259 OID 714653)
...
--
-- TOC entry 190 (class 1259 OID 714661)
...
--
-- TOC entry 191 (class 1259 OID 714669)
...
--
-- TOC entry 192 (class 1259 OID 714671)
...
--
-- TOC entry 193 (class 1259 OID 714678)
...
--
-- TOC entry 194 (class 1259 OID 714685)
...
--
-- TOC entry 195 (class 1259 OID 714692)
...
--
-- TOC entry 196 (class 1259 OID 714701)
...
--
-- TOC entry 197 (class 1259 OID 714714)
...
--
-- TOC entry 198 (class 1259 OID 714717)
...
--
-- TOC entry 199 (class 1259 OID 714720)
...
--
-- TOC entry 200 (class 1259 OID 714722)
...
--
-- TOC entry 201 (class 1259 OID 714737)
...
--
-- TOC entry 202 (class 1259 OID 714739)
...
--
-- TOC entry 203 (class 1259 OID 714742)
...
--
-- TOC entry 204 (class 1259 OID 714744)
...
--
-- TOC entry 205 (class 1259 OID 714747)
...
--
-- TOC entry 206 (class 1259 OID 714749)
...
--
-- TOC entry 207 (class 1259 OID 714755)
...
--
-- TOC entry 208 (class 1259 OID 714758)
...
--
-- TOC entry 209 (class 1259 OID 714761)
...
--
-- TOC entry 210 (class 1259 OID 714763)
...
--
-- TOC entry 211 (class 1259 OID 714778)
...
--
-- TOC entry 212 (class 1259 OID 714780)
...
--
-- TOC entry 213 (class 1259 OID 714783)
...
--
-- TOC entry 214 (class 1259 OID 714785)
...
--
-- TOC entry 215 (class 1259 OID 714788)
...
--
-- TOC entry 216 (class 1259 OID 714790)
...
--
-- TOC entry 217 (class 1259 OID 714796)
...
--
-- TOC entry 218 (class 1259 OID 714799)
...
--
-- TOC entry 219 (class 1259 OID 714801)
...
--
-- TOC entry 220 (class 1259 OID 714804)
...
--
-- TOC entry 221 (class 1259 OID 714806)
...
--
-- TOC entry 222 (class 1259 OID 714821)
...
--
-- TOC entry 223 (class 1259 OID 714823)
...
--
-- TOC entry 224 (class 1259 OID 714826)
...
--
-- TOC entry 225 (class 1259 OID 714828)
...
--
-- TOC entry 226 (class 1259 OID 714831)
...
--
-- TOC entry 227 (class 1259 OID 714833)
...
--
-- TOC entry 228 (class 1259 OID 714839)
...
--
-- TOC entry 229 (class 1259 OID 714841)
...
--
-- TOC entry 230 (class 1259 OID 714843)
...
--
-- TOC entry 2152 (class 2604 OID 714849)
...
--
-- TOC entry 2272 (class 2604 OID 721353)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2187 (class 2604 OID 714850)
...
--
-- TOC entry 2165 (class 2604 OID 714851)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2178 (class 2604 OID 714852)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2223 (class 2604 OID 714853)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2224 (class 2604 OID 714854)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2237 (class 2604 OID 714855)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2238 (class 2604 OID 714856)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2239 (class 2604 OID 714857)
...
--
-- TOC entry 2186 (class 2604 OID 714858)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2240 (class 2604 OID 714859)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2253 (class 2604 OID 714860)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2254 (class 2604 OID 714861)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2255 (class 2604 OID 714862)
-- Name: CodiceScheda; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2256 (class 2604 OID 714863)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2269 (class 2604 OID 714864)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2270 (class 2604 OID 714865)
-- Name: Codice; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2271 (class 2604 OID 714866)
-- Name: CodiceScheda; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2274 (class 2606 OID 714868)
...
--
-- TOC entry 2276 (class 2606 OID 714870)
...
--
-- TOC entry 2278 (class 2606 OID 714872)
...
--
-- TOC entry 2280 (class 2606 OID 714874)
...
--
-- TOC entry 2370 (class 2606 OID 721359)
...
--
-- TOC entry 2372 (class 2606 OID 721357)
...
--
-- TOC entry 2282 (class 2606 OID 714876)
...
--
-- TOC entry 2296 (class 2606 OID 714878)
...
--
-- TOC entry 2298 (class 2606 OID 714880)
...
--
-- TOC entry 2300 (class 2606 OID 714882)
...
--
-- TOC entry 2302 (class 2606 OID 714884)
...
--
-- TOC entry 2306 (class 2606 OID 714886)
...
--
-- TOC entry 2304 (class 2606 OID 714888)
...
--
-- TOC entry 2308 (class 2606 OID 714890)
...
--
-- TOC entry 2286 (class 2606 OID 714892)
...
--
-- TOC entry 2314 (class 2606 OID 714894)
...
--
-- TOC entry 2284 (class 2606 OID 714896)
...
--
-- TOC entry 2310 (class 2606 OID 714898)
...
--
-- TOC entry 2312 (class 2606 OID 714900)
...
--
-- TOC entry 2288 (class 2606 OID 714902)
...
--
-- TOC entry 2320 (class 2606 OID 714904)
...
--
-- TOC entry 2322 (class 2606 OID 714906)
...
--
-- TOC entry 2324 (class 2606 OID 714908)
...
--
-- TOC entry 2326 (class 2606 OID 714910)
...
--
-- TOC entry 2328 (class 2606 OID 714912)
...
--
-- TOC entry 2330 (class 2606 OID 714914)
...
--
-- TOC entry 2332 (class 2606 OID 714916)
...
--
-- TOC entry 2334 (class 2606 OID 714918)
...
--
-- TOC entry 2336 (class 2606 OID 714920)
...
--
-- TOC entry 2338 (class 2606 OID 714922)
...
--
-- TOC entry 2340 (class 2606 OID 714924)
...
--
-- TOC entry 2342 (class 2606 OID 714926)
...
--
-- TOC entry 2344 (class 2606 OID 714928)
...
--
-- TOC entry 2346 (class 2606 OID 714930)
...
--
-- TOC entry 2348 (class 2606 OID 714932)
...
--
-- TOC entry 2350 (class 2606 OID 714934)
...
--
-- TOC entry 2352 (class 2606 OID 714936)
...
--
-- TOC entry 2354 (class 2606 OID 714938)
...
--
-- TOC entry 2356 (class 2606 OID 714940)
...
--
-- TOC entry 2358 (class 2606 OID 714942)
...
--
-- TOC entry 2360 (class 2606 OID 714944)
...
--
-- TOC entry 2362 (class 2606 OID 714946)
...
--
-- TOC entry 2364 (class 2606 OID 714948)
...
--
-- TOC entry 2366 (class 2606 OID 714950)
...
--
-- TOC entry 2316 (class 2606 OID 714952)
...
--
-- TOC entry 2318 (class 2606 OID 714954)
...
--
-- TOC entry 2292 (class 2606 OID 714956)
...
--
-- TOC entry 2294 (class 2606 OID 714958)
...
--
-- TOC entry 2290 (class 2606 OID 714960)
...
--
-- TOC entry 2368 (class 2606 OID 714962)
...
--
-- TOC entry 2373 (class 2606 OID 721365)
...
--
-- TOC entry 2374 (class 2606 OID 714963)
...
--
-- TOC entry 2375 (class 2606 OID 714968)
...
--
-- TOC entry 2376 (class 2606 OID 714973)
...
--
-- TOC entry 2377 (class 2606 OID 714978)
...
--
-- TOC entry 2383 (class 2606 OID 714983)
...
--
-- TOC entry 2384 (class 2606 OID 714988)
...
--
-- TOC entry 2385 (class 2606 OID 714993)
...
--
-- TOC entry 2386 (class 2606 OID 714998)
...
--
-- TOC entry 2387 (class 2606 OID 715003)
...
--
-- TOC entry 2378 (class 2606 OID 715008)
...
--
-- TOC entry 2388 (class 2606 OID 715013)
...
--
-- TOC entry 2389 (class 2606 OID 715018)
...
--
-- TOC entry 2390 (class 2606 OID 715023)
...
--
-- TOC entry 2393 (class 2606 OID 715028)
...
--
-- TOC entry 2394 (class 2606 OID 715033)
...
--
-- TOC entry 2395 (class 2606 OID 715038)
...
--
-- TOC entry 2396 (class 2606 OID 715043)
...
--
-- TOC entry 2397 (class 2606 OID 715048)
...
--
-- TOC entry 2398 (class 2606 OID 715053)
...
--
-- TOC entry 2399 (class 2606 OID 715058)
...
--
-- TOC entry 2400 (class 2606 OID 715063)
...
--
-- TOC entry 2401 (class 2606 OID 715068)
...
--
-- TOC entry 2402 (class 2606 OID 715073)
...
--
-- TOC entry 2403 (class 2606 OID 715078)
...
--
-- TOC entry 2404 (class 2606 OID 715083)
...
--
-- TOC entry 2405 (class 2606 OID 715088)
...
--
-- TOC entry 2406 (class 2606 OID 715093)
...
--
-- TOC entry 2407 (class 2606 OID 715098)
...
--
-- TOC entry 2408 (class 2606 OID 715103)
...
--
-- TOC entry 2409 (class 2606 OID 715108)
...
--
-- TOC entry 2410 (class 2606 OID 715113)
...
--
-- TOC entry 2411 (class 2606 OID 715118)
...
--
-- TOC entry 2412 (class 2606 OID 715123)
...
--
-- TOC entry 2413 (class 2606 OID 715128)
...
--
-- TOC entry 2414 (class 2606 OID 715133)
...
--
-- TOC entry 2415 (class 2606 OID 715138)
...
--
-- TOC entry 2416 (class 2606 OID 715143)
...
--
-- TOC entry 2391 (class 2606 OID 715148)
...
--
-- TOC entry 2392 (class 2606 OID 715153)
...
--
-- TOC entry 2380 (class 2606 OID 715158)
...
--
-- TOC entry 2381 (class 2606 OID 715163)
...
--
-- TOC entry 2379 (class 2606 OID 715168)
...
--
-- TOC entry 2382 (class 2606 OID 715173)
...
-- Completed on 2018-03-01 15:25:27
